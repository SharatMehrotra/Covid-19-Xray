...
@article{cohen2020covid,<br>
  title={COVID-19 image data collection},<br>
  author={Joseph Paul Cohen and Paul Morrison and Lan Dao},<br>
  journal={arXiv},<br>
  url={https://github.com/ieee8023/covid-chestxray-dataset},<br>
  year={2020}<br>
}
